...
urlpatterns = [
    ...
    path('posts/<int:pk>/edit_comment/<int:pk2>/', views.EditComment.as_view(), name='edit_comment'),
    path('posts/<int:pk>/delete_comment/<int:pk2>/', views.DeleteComment.as_view(), name='delete_comment')
]
